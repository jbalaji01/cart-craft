...
export const ProductUpdate = (props: IProductUpdateProps) => {
  ...
  const { productEntity, cartItems, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="cartCraftApp.product.home.createOrEditLabel">Create or edit a Product</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
...
const mapStateToProps = (storeState: IRootState) => ({
  cartItems: storeState.cartItem.entities,
