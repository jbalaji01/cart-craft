...
To display a list of products, allow user to choose products and place them in cart.  Display the list of products placed in the cart, calculate the total price of items in the cart.
...
To build the final jar and optimize the cartCraft application for production, run:
